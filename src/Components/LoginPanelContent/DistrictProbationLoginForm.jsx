...
const DistrictProbationLoginForm = () => {
  return (
    <form method="POST" action="">
      <h4 style={{ textAlign: 'center' }}>District Probation Office Login</h4>
      ...
      <div className="form-group">
        <button type="submit" name="dpo_login" className="btn btn-info">Login</button>
      </div>
    </form>
  );
};

export default DistrictProbationLoginForm;
