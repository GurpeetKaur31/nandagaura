    ...
    <div className="document-section">
      ...
      <ol>
        ...
        <li>
          ...
          <br />
          <center><strong>OR/या</strong></center>
          <br />
          राष्ट्रीय मुक्त विद्यालय / अन्य शिक्षण संस्थान से कक्षा 12 उत्तीर्ण करने वाली आवेदिका द्वारा स्वप्रमाणित अंक पत्र की छायाप्रति
        </li>
        ...
        <li>
          ...
          <a href="/Doc/principle_12_certificate.pdf" target="blank" className="btn btn-success btn-sm">
            (प्रारूप यहाँ से डाउनलोड करें।) <FontAwesomeIcon icon={faDownload} />
          </a>
          <br />
          <center><strong>OR/या</strong></center>
          <br />
        ...
        <li>
          ...
          <a href="/Doc/sanstha_certificate.pdf" target="blank" className="btn btn-success btn-sm">
            (प्रारूप यहाँ से डाउनलोड करें।) <FontAwesomeIcon icon={faDownload} />
          </a>
        </li>
      </ol>
...
function App() {
  ...
  <span className="blinking">Important: </span>
